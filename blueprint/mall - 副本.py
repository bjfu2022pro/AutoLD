...
def confirm():
        ...
        return render_template('pay.html',time=session['time'],danhao=session['danhao'],algorithmic=session['algorithmic'],datas=session['datas'],calculate=session['calculate'])
